...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col font-kalam">
      ...
      <header className="p-4 md:p-6 flex items-center justify-between border-b-2 border-root-fg border-dashed">
        ...
        <nav className="flex items-center gap-4">
          ...
          <div className="flex gap-2">
            <div className="w-4 h-4 rounded-full bg-brand-red sketch-border hover:scale-125 transition-transform cursor-pointer"></div>
            <div className="w-4 h-4 rounded-full bg-brand-blue sketch-border hover:scale-125 transition-transform cursor-pointer"></div>
            <div className="w-4 h-4 rounded-full bg-brand-yellow sketch-border hover:scale-125 transition-transform cursor-pointer"></div>
          </div>
        </nav>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-4xl mx-auto w-full">
        ...
        <ScrollReveal delay={500}>
          <div className="flex flex-col sm:flex-row gap-6 mb-16">
            ...
            <a href="#features" className="sketch-button bg-white text-root-fg text-xl px-8 py-4 flex items-center gap-2 -rotate-1 hover:rotate-0 group">
        ...
        <ScrollReveal delay={100} distance={50}>
          <div className="w-full max-w-3xl mt-24 sketch-card overflow-hidden hover-lift">
            <div className="border-b-2 border-root-fg bg-green-50/50 p-3 flex justify-between items-center bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(0,0,0,0.02)_10px,rgba(0,0,0,0.02)_20px)]">
              <div className="flex gap-2">
            ...
            <div className="p-8 flex items-center justify-center bg-white aspect-video relative overflow-hidden">
              <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle, #000 1px, transparent 1px)", backgroundSize: "20px 20px" }}></div>
              
              <div className="relative w-64 h-48 sketch-box border-brand-blue flex items-center justify-center rotate-[-3deg] bg-white shadow-[4px_4px_0px_#2979ff] hover:rotate-0 transition-transform duration-500 group/box cursor-default">
              ...
              <div className="absolute w-48 h-32 sketch-box border-brand-red flex items-center justify-center rotate-[5deg] bg-white shadow-[4px_4px_0px_#ff3b3b] ml-48 mt-32 hover:rotate-0 transition-transform duration-500 cursor-default animate-float" style={{ animationDelay: "0.5s" }}>
      ...
      {/* Footer */}
      <footer className="mt-20 p-6 border-t-2 border-root-fg flex flex-col items-center gap-6 bg-white/50 text-center">
        ...
        <div className="pt-6 pb-2 border-t-2 border-root-fg/20 border-dashed w-full max-w-md flex items-center justify-center">
          <a href="https://notier.ai" target="_blank" className="group flex items-center gap-3 hover:-translate-y-1 transition-transform sketch-button px-5 py-2.5 bg-[#fffdf6]">
